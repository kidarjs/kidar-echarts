...
const plugins = { "./plugins/dybar.ts": () => import("./dybar.js"), "./plugins/line.ts": () => import("./line.js"), "./plugins/multiLineOrBarX.ts": () => import("./multiLineOrBarX.js"), "./plugins/pie.ts": () => Promise.resolve().then(function() {
  return pie$1;
}) };
const script = {
  name: "KiEchartsPlus",
