...
const plugins = { "./plugins/dybar.ts": () => import("./dybar.js"), "./plugins/line.ts": () => import("./line.js"), "./plugins/pie.ts": () => Promise.resolve().then(function() {
  return pie$1;
}) };
const script = {
  name: "KiEchartsPlus",
...
const _KiEchartsPlus = KiEchartsPlus;
_KiEchartsPlus.install = (vue) => {
  vue.component(_KiEchartsPlus.name, _KiEchartsPlus);
};
function defineConfig(config) {
  return config;
}
_KiEchartsPlus.addPlugin = (plugin) => {
...
export { _KiEchartsPlus as default, defineConfig };
