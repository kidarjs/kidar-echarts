...
Object.freeze({ __proto__: null, [Symbol.toStringTag]: "Module", default: (t2, e) => {
  let n2 = false;
  return function(...r2) {
    let i2 = this;
...
Object.freeze({ __proto__: null, [Symbol.toStringTag]: "Module", default: function(t2, e) {
...
var n = function() {
  ...
  return function() {
    ...
    }, enumerable: true, configurable: true }), e.prototype.get = function(e2) {
...
var s = ["top", "right", "bottom", "left", "width", "height", "size", "weight"], a = typeof MutationObserver != "undefined", c = function() {
  ...
  return t2.prototype.addObserver = function(t3) {
    ...
    r && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), a ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, { attributes: true, childList: true, characterData: true, subtree: true })) : (document.addEventListener("DOMSubtreeModified", this.refresh), this.mutationEventsAdded_ = true), this.connected_ = true);
  ...
  for (var n2 = 0, r2 = Object.keys(e); n2 < r2.length; n2++) {
    var i2 = r2[n2];
    Object.defineProperty(t2, i2, { value: e[i2], enumerable: false, writable: false, configurable: true });
  }
  return t2;
}, f = function(t2) {
...
function _(t2, e, n2, r2) {
  return { x: t2, y: e, width: n2, height: r2 };
}
var y = function() {
  function t2(t3) {
  ...
  var n2, r2, i2, o2, s2, a2, c2, f2 = (r2 = (n2 = e).x, i2 = n2.y, o2 = n2.width, s2 = n2.height, a2 = typeof DOMRectReadOnly != "undefined" ? DOMRectReadOnly : Object, c2 = Object.create(a2.prototype), u(c2, { x: r2, y: i2, width: o2, height: s2, top: i2, right: r2 + o2, bottom: s2 + i2, left: r2 }), c2);
  u(this, { target: t2, contentRect: f2 });
}, g = function() {
  function t2(t3, e, r2) {
...
var ct = function(t2, e, n2) {
  ...
  if (typeof t2 != "function")
    throw new TypeError("Expected a function");
  return at(n2) && (r2 = "leading" in n2 ? !!n2.leading : r2, i2 = "trailing" in n2 ? !!n2.trailing : i2), st(t2, e, { leading: r2, maxWait: e, trailing: i2 });
};
const ut = (() => {
